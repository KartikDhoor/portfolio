					...
					<div className='col-md-2 ml-0 d-none d-md-block '>
						<div className={Day?'container text-col sidebar':'container sidebar text-col1'}>
							...
							<div className={Day?'row text-col':'row text-col1'}>
								<img className={Day?'img text-col':'img text-col1'} src='./images/my1.png' alt='' />
							</div>
							<div>
							...
							<div className={Day?'side-panel text-col':'side-panel text-col1'}>
								<div className={Day?'text-col':'text-col1'}><Link className={Day?'text-col':'text-col1'} target='./' to='https://www.instagram.com/kartik_dhoor?igsh=azZ1bjc4ODR4c2o3'><img className={Day?'side-img text-col':'side-img text-col1'} src='./images/instagram.png'></img></Link></div>
								<div className={Day?'text-col':'text-col1'}><Link className={Day?'text-col':'text-col1'} target='./'><img className={Day?'side-img text-col':'side-img text-col1'} src='./images/facebook.png'></img></Link></div>
								<div className={Day?'text-col':'text-col1'}><Link className={Day?'text-col':'text-col1'} target='./' to="https://github.com/KartikDhoor"><img className={Day?'side-img text-col':'side-img text-col1'} src='./images/github.png'></img></Link></div>
								<div className={Day?'text-col':'text-col1'}><Link className={Day?'text-col':'text-col1'} target='./' to='https://www.linkedin.com/in/kartik-dhoor-56970b247/'><img className={Day?'side-img text-col':'side-img text-col1'} src='./images/linkedin.png'></img></Link></div>
								<div className={Day?'text-col':'text-col1'}><Link className={Day?'text-col':'text-col1'} to='/'><img className={Day?'side-img text-col':'side-img text-col1'} src='./images/web.png'></img></Link></div>
							</div>
												...
												<div className={Day?'row text-col mt-5':'row text-col1 mt-5'}>
													<div className={Day? homeVisible ? "nav-sty1" : 'nav-sty text-col':homeVisible? "dark-nav-sty1" : 'dark-nav-sty'}>
														<img onClick={() => scrollToSection(homeScrollRef)}
															className='icon-img text-col on-click-col'
															src='./images/home-icon-silhouette.png'
															alt='home'
														/>
													</div>
												</div>
									...
									<div className='small-nav d-block d-md-none'>
										<div className={Day?'mt-3 rounded-4 row text-col':'mt-3 rounded-4 row text-col1'}>
											<div className={Day?'col-sm-2 col-2 text-col rounded-4':'col-sm-2 col-2 text-col1 rounded-4'}>
												<img className={Day?'img2  text-col':'img2  text-col1'} src='./images/my1.png'
													onClick={handleSidebar}
												/>
											</div>
								...
								<div className='container-fluid'>
									<div ref={homeRef} id='home' className={Day?"row hero rounded-4 mx-auto zoom2":"row hero1 rounded-4 mx-auto zoom2"}>
										...
										<div className= {Day?'col-md-5 col-lg-4 col-xl-4 col-sm-4 d-none d-sm-block text-col rounded-4':'col-md-5 col-lg-4 col-xl-4 col-sm-4 d-none d-sm-block text-col1 rounded-4'}>
											<img className={Day? 'img-main text-col rounded-4':'img-main text-col1 rounded-4'} src='./images/my1.png' />
										</div>
									</div>
								</div>
							</div>
								...
								<div className='row siz' >
									<div className='col-md-4 col-lg-4 col-xl-4 col-sm-6 col-6'>
										<div className={Day?'col zoom my-responsive-height':'dark-col zoom my-responsive-height'}>
											<img className={Day? 'icon-image':'icon-dark-image'} src='./images/Front end.png'></img>
											<div className={Day?'text-col':'text-col1'}>
									...
									<div className='col-md-4 col-lg-4 col-xl-4 col-sm-6 col-6'>
										<div className={Day?'col zoom my-responsive-height':'dark-col zoom my-responsive-height'}>
											<img className={Day? 'icon-image':'icon-dark-image'} src='./images/Back End.png'></img>
											<div className={Day?'text-col':'text-col1'}>
									...
									<div className='col-md-4 col-lg-4 col-xl-4 col-sm-6 col-6'>
										<div className={Day?'col zoom my-responsive-height':'dark-col zoom my-responsive-height'}>
											<img className={Day? 'icon-image':'icon-dark-image'} src='./images/Management.png'></img>
											<div className={Day?'text-col':'text-col1'}>
									...
									<div className='col-md-4 col-lg-4 col-xl-4 col-sm-6 col-6'>
										<div className={Day?'col zoom my-responsive-height':'dark-col zoom my-responsive-height'}>
											<img className={Day? 'icon-image':'icon-dark-image'} src='./images/Database.png'></img>
											<div className={Day?'text-col':'text-col1'}>
									...
									<div className='col-md-4 col-lg-4 col-xl-4 col-sm-6 col-6'>
										<div className={Day?'col zoom my-responsive-height':'dark-col zoom my-responsive-height'}>
											<img className={Day? 'icon-image':'icon-dark-image'} src='./images/Online Support.png'></img>
											<div className={Day?'text-col':'text-col1'}>
								...
								<div className=''>
									<div className='row'>
										<div className='col-md-4 col-lg-4 col-xl-4 col-sm-6 col-6 zoom'>
											<img className='portfolio-img' src='./images/pic1.png'></img>
										</div>
										<div className='col-md-4 col-lg-4 col-xl-4 col-sm-6 col-6 zoom'>
											<img className='portfolio-img' src='./images/pic2.png'></img>
										</div>
										<div className='col-md-4 col-lg-4 col-xl-4 col-sm-6 col-6 zoom'>
											<img className='portfolio-img' src='./images/pic3.png'></img>
										</div>
										<div className='col-md-4 col-lg-4 col-xl-4 col-sm-6 col-6 zoom'>
											<img className='portfolio-img' src='./images/pic4.png'></img>
										</div>
										<div className='col-md-4 col-lg-4 col-xl-4 col-sm-6 col-6 zoom'>
											<img className='portfolio-img' src='./images/pic5.png'></img>
										</div>
										<div className='col-md-4 col-lg-4 col-xl-4 col-sm-6 col-6 zoom'>
											<img className='portfolio-img' src='./images/pic6.png'></img>
										</div>
									</div>
								</div>
								...
								<div className='row mt-3'>
									<div className='col-md-4 col-lg-4 col-xl-4 col-sm-6 col-6 mt-2'>
										<div className={Day? 'blog-siz text-col zoom':'blog-siz text-col1 zoom'}>
											<div>
												<img className={Day? 'blog-img text-col':'blog-img text-col1'} src='./images/pic1.png' />
											</div>
									...
									<div className={Day? 'blog-siz text-col zoom':'blog-siz text-col1 zoom'}>
											<div>
												<img className={Day? 'blog-img text-col':'blog-img text-col1'} src='./images/pic2.png' />
											</div>
											<div className={Day? 'text-col p-2 rounded-2':'text-col1 p-2 rounded-2'}>
									...
									<div className={Day? 'blog-siz text-col zoom':'blog-siz text-col1 zoom'}>
											<div>
												<img className={Day? 'blog-img text-col':'blog-img text-col1'} src='./images/pic3.png' />
											</div>
											<div className={Day? 'text-col p-2 rounded-2':'text-col1 p-2 rounded-2'}>
									...
									<div className='col-md-4 col-sm-6 col-12 mt-2'>
										<div className={Day?'row mar text-col':'row mar text-col1'}>
											...
											<div className={Day?'row mb-3 text-col m-0':'row mb-3 text-col1 m-0'}>
												<div className={Day? 'col-md-5  text-col':'col-md-5  text-col1'}><img className={Day? 'review-image text-col':'review-image text-col1'} src='./images/temp.jpg' /></div>
							...
							<div className='container'>
								<div className='row' ref={contactRef}>
									...
									<div className='col-md-4 col-sm-12 col-12 mt-5'>
										...
										<div className={Day? 'row text-col mt-5':'row text-col1 mt-5'}>
											<div className={Day?'contact-cen contact-siz text-col':'contact-cen contact-siz text-col1'}><img className='contact-img' src='./images/map.png' /></div>
										...
										<div className={Day? 'row text-col mt-5':'row text-col1 mt-5'}>
											<div className={Day?'contact-cen contact-siz text-col':'contact-cen contact-siz text-col1'}><img className='contact-img' src='./images/link.png' /></div>
											<div className={Day?'row m-0 text-col':'row m-0 text-col1'}>
										...
										<div className={Day? 'row text-col mt-5':'row text-col1 mt-5'}>
											<div className={Day?'contact-cen contact-siz text-col':'contact-cen contact-siz text-col1'}><img className='contact-img' src='./images/phone-call.png' /></div>
											<div className={Day?'row m-0 text-col':'row m-0 text-col1'}>
												<div className={Day?'col-md-6 col-sm-6 col-6 text-col':'col-md-6 col-sm-6 col-6 text-col1'}>
